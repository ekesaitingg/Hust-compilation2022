...
void display(struct node *T,int indent)  {//对抽象语法树的先根遍历
  ...
  if (T)
	...
	case COMP_STM:      printf("%*c复合语句：\n",indent,' ');
                        ...
                        display(T->ptr[0],indent+3);
                        break;
        case COMP_ST_ITEM:  printf("%*c复合语句块\n",indent,' ');
                        display(T->ptr[0],indent+3);
	...
	case ARGS:      i=1;
                    ...
                    break;
        case TERM:
                if (T->ptr[0]) printf("%*c数组: ", indent, ' ');
                else printf("%*cID: ", indent, ' ');
                printf("%s\n", T->type_id);
                display(T->ptr[0], indent+3);
                break;
        case ARRAY:
...
/*        case ARRAY: printf("%*c数组1\n",indent,' ');
                //display(T->ptr[0],indent+3);
                display(T->ptr[1],indent+3);
                    break;
        case ID_ARRAY: printf("%*c数组\n",indent,' ');
                      display(T->ptr[0],indent+3);
                    break;
        case ARRAY: printf("%*c数组:\n",indent, ' ');
                    display(T->ptr[0],indent+3);
                    display(T->ptr[1],indent+3);
                    break;
        case ID_ARRAY: display(T->ptr[0],indent); */
         }
      }
}
